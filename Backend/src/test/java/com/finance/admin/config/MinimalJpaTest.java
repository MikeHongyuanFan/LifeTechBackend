...
/**
 * Minimal JPA test that doesn't load the main application context
 */
@DataJpaTest
@ContextConfiguration(classes = MinimalJpaTest.TestConfig.class)
