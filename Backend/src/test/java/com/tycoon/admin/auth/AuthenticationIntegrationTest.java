package com.tycoon.admin.auth;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.tycoon.admin.auth.dto.LoginRequest;
import com.tycoon.admin.auth.dto.LoginResponse;
import com.tycoon.admin.auth.dto.MfaVerificationRequest;
import com.tycoon.admin.auth.entity.AdminRole;
import com.tycoon.admin.auth.entity.AdminUser;
import com.tycoon.admin.auth.entity.AdminUserStatus;
import com.tycoon.admin.auth.repository.AdminUserRepository;
import com.tycoon.admin.auth.service.MfaService;
...
public class AuthenticationIntegrationTest {
    ...
    private void createTestUsers() {
        // Regular user
        testUser = new AdminUser("testadmin", "test@tycoon.com", passwordEncoder.encode("password123"));
        ...
        // MFA-enabled user
        mfaUser = new AdminUser("mfaadmin", "mfa@tycoon.com", passwordEncoder.encode("password123"));
        ...
        // Locked user
        lockedUser = new AdminUser("lockedadmin", "locked@tycoon.com", passwordEncoder.encode("password123"));
