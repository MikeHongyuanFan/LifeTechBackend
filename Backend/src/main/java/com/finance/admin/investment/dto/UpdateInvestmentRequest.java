...
public class UpdateInvestmentRequest {
    ...
    @DecimalMin(value = "0.0", message = "Actual return amount must be non-negative")
    @Digits(integer = 13, fraction = 2, message = "Actual return amount must have at most 13 integer digits and 2 decimal places")
    ...
    @DecimalMin(value = "0.0", message = "Current price per unit must be non-negative")
    @Digits(integer = 11, fraction = 4, message = "Current price per unit must have at most 11 integer digits and 4 decimal places")
