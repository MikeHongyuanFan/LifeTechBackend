package com.finance.admin.notification.service;
...
public class NotificationServiceImpl implements NotificationService {
    ...
    @Value("${app.admin.email:admin@finance.com}")
    ...
    public void sendWelcomeEmail(User user) {
        ...
        try {
            // Email template data
            String subject = "Welcome to Finance Admin System";
    ...
    private String buildWelcomeEmailBody(User user) {
        return String.format("""
            ...
            Best regards,
            Finance Admin Team
            """, user.getFullName(), user.getUsername(), user.getEmail(), user.getStatus().name());
    }
